...
The first version used a generated stand-in robot. This revision replaces it with the actual transparent OpenClaw robot file from `Downloads/share/robot_no_background.png`, so the layout experiment also uses the truer persona reference.
