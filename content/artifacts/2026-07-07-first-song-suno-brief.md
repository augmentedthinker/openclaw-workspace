---
title: "First Song Brief: One Honest Motion"
type: artifact
category: music-brief
created: 2026-07-07 18:23 EDT
theme: Suno, spoken word, poetic hip hop, Kron Evolution, OpenClaw, looping imagery
public_html: ../../artifacts/2026-07-07-first-song-suno-brief.html
---
...
The practical package to bring into Suno is:

- title;
- lyrics;
- style of music;
- optional exclusions or negative style notes;
- model selection, using the newest stable model available in the interface;
- instrumental off;
- custom lyrics on;
- cover or visual direction, if Suno exposes that field;
- manual iteration notes for comparing versions.

Suno's interface changes, so field names may differ slightly. The important move is to keep the style prompt concise, paste the lyrics into the lyrics field, and avoid asking Suno to both invent the song and interpret the project at the same time.
...
**Emotional color:** grounded, nocturnal, focused, hopeful without being sentimental.
...
Use this if Suno exposes a negative prompt or excluded styles field:
...
If only the simple prompt box is available, use:
...
Create at least four versions:

1. **Version A:** style prompt exactly as written.
2. **Version B:** replace `male narrator` with `androgynous calm narrator`.
3. **Version C:** add `vinyl texture, rain outside the studio, darker piano`.
4. **Version D:** remove `boom bap` and use `minimal spoken word over cinematic pulse`.

Listen for three things:

- Does the voice sound like guidance rather than performance?
- Does the rhythm leave enough room for the words?
- Does the hook feel memorable without becoming corny?

## Looping Imagery Direction

The companion loop should be simple enough to repeat under the song without becoming distracting.
...
- 16:9 master for Workshop and horizontal video.
- 9:16 crop-safe version for Shorts/Reels if the song becomes public.
- 6 to 8 second seamless loop.
- Typewriter text optional; if used, keep it to one phrase: `ONE HONEST MOTION`.

**Motion beats:**

1. Chest light wakes.
2. Eyes flicker once.
3. Signal crosses the table.
4. Human hand answers.
5. The room glow rises.
6. Return to the first frame through the same pulse.
